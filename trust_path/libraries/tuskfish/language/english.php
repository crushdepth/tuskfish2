...
\define("TFISH_ERROR_IMAGE_TOO_LARGE", "Upload failed: Image dimensions exceed the 10000px limit.");
...
\define("TFISH_WEBAUTHN_ERROR_INVALID_CREDENTIAL_ID", "Invalid credential ID returned by library");
\define("TFISH_WEBAUTHN_ERROR_INVALID_PUBLIC_KEY", "Invalid public key returned by library");
\define("TFISH_WEBAUTHN_ERROR_INVALID_SIGNATURE_COUNTER", "Invalid signature counter returned by library");
\define("TFISH_WEBAUTHN_ERROR_INVALID_TRANSPORTS", "Invalid transports data returned by library");
\define("TFISH_WEBAUTHN_ERROR_INVALID_AAGUID", "Invalid AAGUID returned by library");
\define("TFISH_WEBAUTHN_ERROR_INVALID_TFISH_URL", "Invalid TFISH_URL configuration");
