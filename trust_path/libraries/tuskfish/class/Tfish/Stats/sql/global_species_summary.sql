...
-- indexed lookup per year. The /production/ page also reads it — for its landing menu (biggest
...
--
--     sqlite3 trust_path/database/aquaculture-fisheries-trade.db < global_species_summary.sql
--
...
-- Covering index for the /production/ species filter, which needs the distinct set of species that
