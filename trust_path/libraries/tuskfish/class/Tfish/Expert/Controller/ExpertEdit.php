...
/**
 * \Tfish\Expert\Controller\ContentEdit class file.
 *
...
/**
 * Controller for editing expert objects.
 *
 * @copyright   Simon Wilkinson 2019+ (https://tuskfish.biz)
 * @license     https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html GNU General Public License (GPL) V2
 * @author      Simon Wilkinson <simon@isengard.biz>
...
class ExpertEdit
{
    ...
    /**
     * Cancel the add/edit expert action.
     *
    ...
    /**
     * Save the new/edited expert object.
     *
     * @return  array Empty array (the output of this action is not cached).
     */
